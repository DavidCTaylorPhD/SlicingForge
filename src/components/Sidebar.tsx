      ...
      <div className="p-6 space-y-8 flex-grow">
        ...
        <section>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2"><span className="text-xs text-slate-500 mb-1 block">Thickness ({material.unit})</span><input type="number" value={material.thickness} onChange={(e) => setMaterial({ ...material, thickness: Number(e.target.value) })} className="w-full bg-slate-800 border border-slate-700 rounded px-3 py-2 text-sm text-white focus:outline-none focus:border-indigo-500" /></div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <div>
                ...
                <p className="text-[10px] text-slate-500 mt-2">Total slices = Model Height / Layer Height</p>
            </div>
          </div>
        </section>
